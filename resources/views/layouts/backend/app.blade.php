...
<head>
    ...
    <!-- fontawesome icon -->
    <link rel="stylesheet" href="assets/backend/fonts/fontawesome/css/fontawesome-all.min.css">
    <!-- animation css -->
    <link rel="stylesheet" href="assets/backend/plugins/animation/css/animate.min.css">
...
<body class="">
        ...
        <div class="navbar-wrapper ">
            <div class="navbar-brand header-logo">
                <a href="index.html" class="b-brand">
                    <img src="assets/backend/images/logo.svg" alt="" class="logo images">
                    <img src="assets/backend/images/logo-icon.svg" alt="" class="logo-thumb images">
                </a>
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('home')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Home</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('about')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">About</span></a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="assets/backend/images/user/avatar-1.jpg" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="assets/backend/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="assets/backend/images/user/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="assets/backend/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
                                <span>John Doe</span>
                ...
                <ul class="iew-download">
                    <li>
                        <a href="http://www.google.com/chrome/">
                            <img src="assets/backend/images/browser/chrome.png" alt="Chrome">
                            <div>Chrome</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.mozilla.org/en-US/firefox/new/">
                            <img src="assets/backend/images/browser/firefox.png" alt="Firefox">
                            <div>Firefox</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://www.opera.com">
                            <img src="assets/backend/images/browser/opera.png" alt="Opera">
                            <div>Opera</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.apple.com/safari/">
                            <img src="assets/backend/images/browser/safari.png" alt="Safari">
                            <div>Safari</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                            <img src="assets/backend/images/browser/ie.png" alt="">
                            <div>IE (11 & above)</div>
                        </a>
                    </li>
                </ul>
    ...
    <!-- Required Js -->
    <script src="assets/backend/js/vendor-all.min.js"></script>
    <script src="assets/backend/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="assets/backend/js/pcoded.min.js"></script>
