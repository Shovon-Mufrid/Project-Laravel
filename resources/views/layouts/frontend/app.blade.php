...
<head>
    ...
    <link href="assets/frontend/lib/twentytwenty/twentytwenty.css" rel="stylesheet" />
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle {{ Route::is('service') ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu m-0">
                        <a href="price.html" class="dropdown-item">Pricing Plan</a>
                        <a href="team.html" class="dropdown-item">Our Dentist</a>
                        <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                        <a href="{{ route('service')}}" class="dropdown-item">Log In</a>
                    </div>
                </div>
 ...
 {{-- Master file layout --}}
    ...
    <script src="assets/frontend/lib/twentytwenty/jquery.event.move.js"></script>
    <script src="assets/frontend/lib/twentytwenty/jquery.twentytwenty.js"></script>
